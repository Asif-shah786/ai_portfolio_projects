import 'package:ai_portfolio_projects/libraries/core_ui/window_size/window_size_calculator.dart';
...
class _CompactLayout extends StatefulWidget {
  ...
  const _CompactLayout({Key? key, required this.navigationShell}) : super(key: key);

  @override
  State<_CompactLayout> createState() => _CompactLayoutState();
}

class _CompactLayoutState extends State<_CompactLayout> with AutomaticKeepAliveClientMixin {
  @override
...
class _NonCompactLayoutState extends State<_NonCompactLayout> with AutomaticKeepAliveClientMixin {
  @override
  bool get wantKeepAlive => true;
